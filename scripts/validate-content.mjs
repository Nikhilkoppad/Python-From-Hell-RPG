...
const projectCount=(projects.match(/id:'/g)||[]).length;
...
console.log(`Content checks passed: ${lessonCount} lessons, ${debugCount} debugging cases, ${interviewCount} interview questions, ${bossCount} bosses / ${phaseCount} phases, ${projectCount} projects, 12 Hell layers.`);
