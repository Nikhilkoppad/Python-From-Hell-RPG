...
export const entranceChallenges: Challenge[] = [
  {
    ...
    difficulty: 1,
    hints: [
      'The print() function sends text to stdout.',
      'Keep the text inside quotes.',
      'The required text is exactly: hello, hell',
    ],
    tests: [
      {
        id: 'basic-output',
        description: 'prints the target phrase',
        code: 'print("hello, hell")',
        expectedOutput: 'hello, hell',
      },
    ],
  },
  {
    ...
    hints: [
      ...
      'Use = for assignment.',
      'The variable must be named soul.',
    ],
    tests: [
      {
        id: 'variable-output',
        description: 'prints the assigned value',
        code: 'soul = 13\nprint(soul)',
        expectedOutput: '13',
      },
    ],
  },
  {
    ...
    difficulty: 2,
    hints: [
      'type(x) tells you the runtime type of x.',
      'A type object has a __name__ attribute.',
      'For 42, the type name is int.',
    ],
    tests: [
      {
        id: 'type-output',
        description: 'prints the runtime type name',
        code: 'value = 42\nprint(type(value).__name__)',
        expectedOutput: 'int',
      },
    ],
